...
{      
    ...
    constructor(props)
    {
        ...
        this.state = {redirectToDisplayTshirts:false,
    ...
    {                 
        return (
            <div className="payPalMessage">
                ...
                {this.state.redirectToDisplayTshirts ? <Redirect to="/DisplayTshirts"/> : null} 
                ...
                <p id="payPalPaymentIDButton"><Link className={this.state.buttonColour} to={"/DisplayTshirts"}>Continue</Link></p>                                     
            </div>
        )
    }
}