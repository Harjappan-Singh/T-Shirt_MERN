...
export default class EditTshirt extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`${SERVER_HOST}/tshirts/${this.props.match.params.id}`)
      .then((res) => {
        if (res.data) {
  ...
  handleSubmit = (e) => {
    ...
    if (validationResult.isValid) {
      ...
      axios
        .put(
          `${SERVER_HOST}/tshirts/${this.props.match.params.id}`,
          tshirtObject
        )
        .then((res) => {
          if (res.data) {
      ...
      <div className="form-container">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div>
            ...
            />
            {wasSubmittedAtLeastOnce && errors.brand && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.name && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.description && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.category && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.type && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.color && (
          ...
          <div>
            ...
            <label>
              ...
              <input
                ...
                name="sizes"
                value="XXS"
                checked={this.state.sizes.includes('XXS')}
            ...
            <label>
              ...
              <input
                ...
                name="sizes"
                value="XS"
                checked={this.state.sizes.includes('XS')}
                onChange={this.handleSizeChange}
              />{' '}
              XS{' '}
            </label>
            <label>
              ...
              <input
                ...
                name="sizes"
                value="S"
                checked={this.state.sizes.includes('S')}
                onChange={this.handleSizeChange}
              />{' '}
              S{' '}
            </label>
            <label>
              ...
              <input
                ...
                name="sizes"
                value="M"
                checked={this.state.sizes.includes('M')}
                onChange={this.handleSizeChange}
              />{' '}
              M{' '}
            </label>
            <label>
              ...
              <input
                ...
                name="sizes"
                value="L"
                checked={this.state.sizes.includes('L')}
                onChange={this.handleSizeChange}
              />{' '}
              L{' '}
            </label>
            <label>
              <input
                ...
                name="sizes"
                value="XL"
                checked={this.state.sizes.includes('XL')}
                onChange={this.handleSizeChange}
              />{' '}
              XL{' '}
            </label>
            <label>
              <input
                ...
                name="sizes"
                value="XXL"
                checked={this.state.sizes.includes('XXL')}
                onChange={this.handleSizeChange}
              />{' '}
              XXL{' '}
            </label>
            <label>
              <input
                ...
                name="sizes"
                value="XXXL"
                checked={this.state.sizes.includes('XXXL')}
                onChange={this.handleSizeChange}
              />{' '}
              XXXL{' '}
            </label>
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.price && (
          ...
          <div>
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {wasSubmittedAtLeastOnce && errors.countInStock && (
              <span className="error-message">{errors.countInStock}</span>
            )}
          </div>
