      ...
      <div>
        ...
        {localStorage.accessLevel > ACCESS_LEVEL_GUEST || this.state.addressSubmitted ? (
          <div>
            ...
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.name && "Name is required"}</div>
            <input
              name="name"
              type="text"
              placeholder="Name"
            ...
            />
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.email && "Valid email is required"}</div>
            <input
              name="email"
              type="text"
              placeholder="Email"
              ...
              onChange={this.handleChange}
            />
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.addressLine1 && "Address Line 1 is required"}</div>
            <input
              name="addressLine1"
              type="text"
              ...
              onChange={this.handleChange}
            />
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.city && "City is required"}</div>
            <input
              name="city"
              type="text"
              placeholder="City"
              ...
              onChange={this.handleChange}
            />
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.county && "County is required"}</div>
            <select
              id="county-dropdown"
              name="county"
...
<option value="Wicklow">Wicklow</option>
            ...
            <br />
            <div className="error">{this.state.wasSubmittedAtLeastOnce && !errors.eircode && "Valid Eircode is required"}</div>
            <input
              name="eircode"
              type="text"
              placeholder="Eircode"
